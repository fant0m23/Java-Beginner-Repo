/*
   Напишите программу, представляющую телефонную книгу. Программа должна иметь следующие функции:
        add(String name,Integer phoneNum) - добавляет запись в телефонную книгу. Если запись
        с именем name уже существует, добавляет новый номер телефона в существующую запись.
...
class PhoneBook {
    ...
    public void add(String name, Integer phoneNum) {
        if (phoneBook.containsKey(name)) {
            ...
            // короче и правильнее: phoneBook.get(name).add(phoneNum);
...
// Не удаляйте этот класс - он нужен
